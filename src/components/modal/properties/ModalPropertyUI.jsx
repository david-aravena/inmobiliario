...
export default function Modal({itemSelected, setItemSelected}){
  return(
    <>
          ...
          <div className={styles.imagesContainer}>
            <div className={styles.imageSelectedContainer}>
              {itemSelected.images.length && (
                <img src={URL.createObjectURL(itemSelected.images[itemSelected.imageSelected || 0])} alt="error" height={"100%"} style={{objectFit:"cover", maxWidth: "100%"}} />
              )}
            </div>
            <div style={{
              width: "100%", 
